...
const updatePat = (event) => window.localStorage.setItem('gh_pat', event.target.value);
    ...
    return html`
        <dialog id="config_modal" class="modal">
            <div class="modal-box">
                ...
                <p class="py-4">
                    Add a GitHub personal access token that has pull request read
                    privileges for the repo you'd like to access.
                </p>
